...
select employees1.employee_name as name,
	salary1.monthly_salary as salary
from employees1,
	salary1,
	employee_salary1
...
from salary1
	left join employee_salary1 on salary1.id = employee_salary1.salary_id
...
select employees1.employee_name as name
from employees1
	left join employee_salary1 on employees1.id = employee_salary1.employee_id
where employee_salary1.employee_id is null;
...
select employees1.employee_name,
	roles1.role_name,
	salary1.monthly_salary
from salary1
	join employee_salary1 on salary1.id = employee_salary1.salary_id
	join employees1 on employee_salary1.employee_id = employees1.id
	join roles_employee1 on employees1.id = roles_employee1.employee_id
